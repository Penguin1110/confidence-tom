...
from confidence_tom.data.task_models import AgentRun, DynamicTask, TaskResult, TrajectoryStep
from confidence_tom.eval.evaluators import BenchmarkEvaluator
...
class AgentOutput(BaseModel):
    ...
    trajectory: list[AgentStepOutput] = Field(
        description=(
            "Step-by-step execution trace. Each step has thought, action, "
            "observation, and step_confidence."
        )
    )
