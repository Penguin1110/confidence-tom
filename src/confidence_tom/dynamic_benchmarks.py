...
DYNAMIC_BENCHMARKS: dict[str, DynamicBenchmarkSpec] = {
    ...
    "birdsql": DynamicBenchmarkSpec(
        ...
        recommended_python="3.10+",
        notes=(
            "BIRD-SQL is distributed inside the DAMO-ConvAI repository rather than as a PyPI package.",
            "The full benchmark data can be large; keep it in an external directory instead of vendoring it into this repo.",
        ),
    ),
