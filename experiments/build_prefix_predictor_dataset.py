...
def main() -> None:
    ...
    meta = {
        ...
        "notes": [
            ...
            "Rollout outcomes and continuation token totals are intentionally excluded to avoid leakage.",
            "Confidence-related text features are extracted from prefix_text in the main result JSONs.",
        ],
